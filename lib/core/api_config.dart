class ApiConfig {
  ...
  static const String getDistrbusiKreditEndpoint = "${baseUrl}get_distribusi_kredit.php";
  ...
  static const String getDisKreditEndpoint = "${baseUrl}get_distribusi_anggota.php";
