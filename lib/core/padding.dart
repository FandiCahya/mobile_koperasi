...
class AppPadding {
  ...
  static const EdgeInsets paddingVerticalMedium = EdgeInsets.symmetric(vertical: 14);
  static const EdgeInsets paddingVerticalLarge = EdgeInsets.symmetric(vertical: 20);
