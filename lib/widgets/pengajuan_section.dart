...
import 'card/pengajuan_card.dart'; // Import kartu untuk menampilkan data pengajuan kredit
import '../core/text_styles.dart'; // Import file untuk mengatur gaya teks
import 'All/AllPengajuanPage.dart'; // Import halaman untuk melihat semua pengajuan kredit
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: ApplicantCard(
                        ...
                        statusPengajuan: applicant["status_pengajuan"],
                      ),
                    );
                  },
                ),
